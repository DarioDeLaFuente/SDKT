  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-svh p-4">
        ...
        <ImageGallery360 
          ...
          autoRotate={true}
        />
        <div className="relative z-2 w-[55svh]">
        <div className="relative z-2 h-[15svh]  w-[55svh] flex justify-center  text-white pt-4"><Label htmlFor="email" className="text-xl">Meld deg på forhåndssalget</Label></div>
        <div className="relative z-2 bg-white/80 text-black p-8 backdrop-blur-lg pointer-events-auto">
